...
export const StudentInfo = ({ data }: StudentInfoProps) => {
  return (
    <div className="grid grid-cols-3 gap-y-2 gap-x-4 max-w-[400px] p-2 ">
      <div className="text-left font-semibold">NISN</div>
      ...
      <div className="text-left font-semibold">Class</div>
      <div className="col-span-2">
